...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bn_lock = QtWidgets.QPushButton(self.groupBox_2)
        self.bn_lock.setObjectName("bn_lock")
        self.gridLayout_3.addWidget(self.bn_lock, 4, 1, 1, 1)
        self.bn_unlock = QtWidgets.QPushButton(self.groupBox_2)
        self.bn_unlock.setObjectName("bn_unlock")
        self.gridLayout_3.addWidget(self.bn_unlock, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bn_lock.setText(_translate("MainWindow", "上锁"))
        self.bn_unlock.setText(_translate("MainWindow", "解锁"))
        ...
        self.action_Stop.setText(_translate("MainWindow", "暂停"))
